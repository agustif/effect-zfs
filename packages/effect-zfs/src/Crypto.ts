...
import { decodeNameArg, decodePropertyArg } from "./internal/decode.js"
import { VolumeSize, minPassphraseLen, minPbkdf2Iterations } from "./Limits.js"
...
import { dataset, type KindedDataset } from "./Schemas.js"
    ...
    Effect.gen(function*() {
      ...
      const encryptedProperties = (
        ...
        encodeProperties({
          ...
          ...(extras.pbkdf2iters === undefined ? {} : { pbkdf2iters: extras.pbkdf2iters })
        })
