...
import {
  ...
  SendOptions,
  SendProgress,
  type SendProgressReport,
  type SendSpaceEstimate,
  SnaprangeSpace
} from "./Args.js"
import type { BookmarkName, DatasetName, SnapshotName } from "./Name.js"
import { decodeNameArg } from "./internal/decode.js"
import { ZfsProtocol, type Failure } from "./Protocol.js"
import { Snapshot } from "./Schemas.js"

const snapshotNameOf = (value: Snapshot | SnapshotName): SnapshotName =>
