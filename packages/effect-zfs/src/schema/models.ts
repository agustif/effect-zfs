...
export class PropertyGetRow extends Schema.Class<PropertyGetRow>("effect-zfs/PropertyGetRow")({
  ...
  /** Decoded through `defineProperty.schema` when the property is known. */
  ...
  Schema.decodeTo(
    ...
    SchemaTransformation.transform({
      ...
      encode: (scan) => ({
        ...
        ...(scan.bytesPerScan === undefined
          ? {}
          : { bytes_per_scan: scan.bytesPerScan, bytesPerScan: scan.bytesPerScan }),
        ...
        ...(scan.scrubSpentPaused === undefined
          ? {}
          : { scrub_spent_paused: scan.scrubSpentPaused, scrubSpentPaused: scan.scrubSpentPaused }),
        ...(scan.issuedBytesPerScan === undefined
          ? {}
          : { issued_bytes_per_scan: scan.issuedBytesPerScan, issuedBytesPerScan: scan.issuedBytesPerScan }),
...
export class PoolStatus extends Schema.Class<PoolStatus>("effect-zfs/PoolStatus")({
  ...
  config: Schema.optionalKey(Schema.Array(Schema.Unknown)),
