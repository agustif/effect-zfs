...
import { decodeCodec, decodeNameArg } from "./internal/decode.js"
import type { PropertyDefinition, PropertyValue, ResolvedProperty } from "./Property.js"
import { ZfsProtocol, type Failure } from "./Protocol.js"
import { Bookmark, Snapshot } from "./Schemas.js"

export { Bookmark }

const bookmarkNameOf = (value: Bookmark | BookmarkName): BookmarkName =>
  value instanceof Bookmark ? value.name : value
  ...
  static readonly layer = Layer.effect(
    ...
    Effect.gen(function*() {
      ...
      const create = Effect.fn("Bookmarks.create")(function*(
        ...
        yield* zfs.createBookmark(new CreateBookmark({
          source: sourceName,
          name: full
        }))
      ...
      const list = Effect.fn("Bookmarks.list")(function*(
        ...
        return rows.map((row) => new Bookmark({
          name: row.name,
      ...
      const get = Effect.fn("Bookmarks.get")(function*<P extends PropertyDefinition<string, any, any, any>>(
        ...
        const row = yield* zfs.getBookmarkProps(new GetBookmarkProps({
