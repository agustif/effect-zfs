...
import { JsonStatusCodec, poolHealthOf, PoolStatus, VdevStatus } from "../schema/models.js"
...
export const isUnsupportedStatusJsonFlag = (stderr: string) => /invalid option/.test(stderr.toLowerCase())
