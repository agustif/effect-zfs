...
import { Dataset, Snapshot } from "./Schemas.js"
  ...
  static readonly layer = Layer.effect(
    ...
    Effect.gen(function*() {
      ...
      const create = Effect.fn("Snapshots.create")(function*(
        ...
        yield* zfs.createSnapshot(new CreateSnapshot({
          name: full,
      ...
      const rollback = Effect.fn("Snapshots.rollback")(function*(
        ...
        yield* zfs.rollback(new Rollback({
      ...
      return Snapshots.of({ create, destroy, clone, list, rollback, promote, rename, hold, holds, release, redact, diff })
    })
  )
}
